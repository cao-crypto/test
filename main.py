...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log_s3dis_DSM/',
    ...
    parser.add_argument('--embedding_num', type=int, default=10, help='semantic input')
    ...
    parser.add_argument('--use_channelwise_dynamic_fusion', action='store_true',
                        help='If use channel-wise dynamic fusion')

    # Boundary-aware shallow branch configuration
    parser.add_argument('--use_boundary_shallow', action='store_true',
                        help='If use boundary-aware shallow branch')
    parser.add_argument('--lambda_boundary', type=float, default=0.1,
                        help='Weight for boundary loss')
    parser.add_argument('--boundary_knn_k', type=int, default=5,
                        help='k for kNN boundary detection')

    # Backbone configuration
    parser.add_argument('--backbone_name', type=str, default='dgcnn', choices=['dgcnn', 'ptv3', 'mamba'],
                        help='Backbone name')
